...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active"><spring:message code="crumbs.create" /></li>
	</ul>
	<!-- .breadcrumb -->
</div>
...
<#list columns as col>
	<#if col["DATA_TYPE"] != "bit">
						<div class="form-group">
							<label class="col-md-3 control-label no-padding-right" for="form-field-1">${col["COLUMN_NAME"]}</label>
							<div class="col-md-9"> 
								<input type="text" id="${col['COLUMN_NAME']}" name="${col['COLUMN_NAME']}" placeholder="" class="col-md-10 col-md-5">
							</div>
						</div>
	</#if>			
</#list>
